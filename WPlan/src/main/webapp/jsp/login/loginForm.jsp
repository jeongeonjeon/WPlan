            ...
            <div class="modal-contents login-modal">
                ...
                <div class="login-body">
                    <div class="ctnr_login_btn row">
                        ...
                        <div class="col-xs-6 padding-right-5 margin-top-10">
                            <a href="javascript:;" class="btn_sns sns_facebook btn_sns_facebook">페이스북 로그인</a>
                        </div>
                        <div class="col-xs-6 padding-left-5 margin-top-10">
                            <a href="javascript:;" class="btn_sns sns_google" id="google_login1">구글 로그인</a>
                        </div>
