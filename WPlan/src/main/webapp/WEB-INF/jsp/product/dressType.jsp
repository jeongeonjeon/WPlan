...
$(document).ready(function(){
	$('.row.box.mermaid').click(function(){
		location.href="${pageContext.request.contextPath}/product/dress/mermaid";
	});
	$('.row.box.bell').click(function(){
		location.href="${pageContext.request.contextPath}/product/dress/bell";
	});
	$('.row.box.short').click(function(){
		location.href="${pageContext.request.contextPath}/product/dress/short";
	});
	$('.row.box.empire').click(function(){
		location.href="${pageContext.request.contextPath}/product/dress/empire";
	});
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-sm-12 col-12 dressType box-1">
						<div class="row box mermaid" data-aos="fade-left" data-aos-delay="300">
							<div class="imgBox">
								<a href="javascript:;">
									<img
					...
					<div class="col-lg-4 col-sm-12 col-12 dressType box-2">
						<div class="row box bell" data-aos="fade-left" data-aos-delay="300">
							<div class="imgBox">
								<a href="javascript:;">
									<img
							...
							<div class="textBox">
								<a href="javascript:;">
									...
									아래로 갈 수록 넓어지는 벨라인 드레스가 다리를 길어보이게 하여 작은 체형을 보완해줄 수 있습니다. </p>
								</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-12 col-12 dressType box-3">
						<div class="row box short" data-aos="fade-left" data-aos-delay="300">
							<div class="imgBox">
								<a href="javascript:;">
									<img
					...
					<div class="col-lg-4 col-sm-12 col-12 dressType box-4">
						<div class="row box empire" data-aos="fade-left" data-aos-delay="300">
							<div class="imgBox">
								<a href="javascript:;">
									<img
							...
							<div class="textBox">
								<a href="javascript:;">
									<h4>Empire Line</h4>
									<p>허리 선이 높게 잡힌 엠파이어 드레스는 다리 길이가 길어보이기 때문에 작은 키가를 보완해줄 수 있는 타입의 드레스입니다.</p>
								</a>
							</div>
						</div>
					</div>
